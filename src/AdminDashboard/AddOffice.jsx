...
import { FaPlus, FaBuilding, FaLayerGroup, FaCheck, FaSpinner, FaTrash } from "react-icons/fa";
      ...
      <div className="w-full max-w-3xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 transition-all hover:shadow-xl">
          <div className="bg-gradient-to-r from-[#f9f1ea] to-[#fcf8f5] p-4 border-l-4 border-[#E68332]">
            ...
            <p className="text-center text-gray-600 mt-1">नयाँ कार्यालय र सम्बन्धित विभागहरू थप्नुहोस्</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-3">
                <label className="block text-gray-800 font-medium flex items-center">
              ...
              {departments.map((department, index) => (
                <div key={index} className="flex items-center gap-2 mb-3 group">
                  ...
                  <button
                    ...
                    className={`text-red-500 p-2 rounded-md hover:bg-red-100 transition-colors ${departments.length === 1 ? 'opacity-50 cursor-not-allowed' : ''}`}
