...
const NonTransferFile = () => {
  ...
  // Add handleTransfer function if missing
  ...
  return (
    <div className="p-6 min-h-screen bg-gray-50">
      {/* Enhanced header */}
      <div className="mb-6 bg-white p-6 rounded-lg shadow-md border-l-4 border-green-500 transition-all duration-300 hover:shadow-lg">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">
          स्थानान्तरण नगरिएको फाइल
        </h2>
        <p className="text-gray-600">अहिलेसम्म स्थानान्तरण नगरिएका फाइलहरूको सूची</p>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="pl-10 w-full py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
            />
          </div>
          ...
          <div className="flex items-center">
            <button 
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-md border ${showFilters ? 'bg-green-500 text-white' : 'bg-white text-gray-700 border-gray-300'} transition-colors duration-200`}
            >
              <FaFilter size={14} />
              <span>फिल्टरहरू</span>
            </button>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 w-full py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  />
                </div>
              </div>
                  ...
                  filteredFiles.map((file, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-medium">
                        <div className="flex items-center">
                          <FaFileAlt className="text-green-500 mr-2 opacity-70" />
                          {file.file_name}
                        </div>
                      </td>
            ...
            <div className="mb-4">
              <label className="block">
                ...
                <select
                  ...
                  className="mt-1 block w-full border border-gray-300 rounded p-2.5 focus:outline-none focus:ring-2 focus:ring-green-400 transition-colors"
                  disabled={isLoading}
                >
