...
const ViewMoreFileDetails = () => {
  ...
  return (
    <div className="w-full min-h-screen p-4 md:p-6 bg-gray-50">
      ...
      <div onClick={handleNavigate} className="fixed top-4 left-4 z-10 group">
      ...
      <div className="mb-6 pt-10 md:pt-16">
                  ...
                  <div className="overflow-auto rounded-lg shadow-lg border border-gray-200 mb-4">
                    <table className="min-w-full divide-y divide-gray-200 table-fixed">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        ...
                        {Array.isArray(letters_and_documents) &&
                        letters_and_documents.length > 0 ? (
